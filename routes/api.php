...
Route::post('tasks-upload-image', [\App\Http\Controllers\Api\TaskController::class, 'uploadImage']);
...
Route::get('data-fields/{id}/stage', [\App\Http\Controllers\Api\DataFieldController:: class, 'index']);
Route::post('data-fields', [\App\Http\Controllers\Api\DataFieldController::class, 'store']);
Route::put('data-fields/{id}', [\App\Http\Controllers\Api\DataFieldController::class, 'update']);
Route::delete('data-fields/{id}', [\App\Http\Controllers\Api\DataFieldController::class, 'destroy']);
